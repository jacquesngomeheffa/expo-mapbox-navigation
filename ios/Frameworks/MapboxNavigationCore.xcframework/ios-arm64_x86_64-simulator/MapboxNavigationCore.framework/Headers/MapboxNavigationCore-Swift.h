...
#ifndef MAPBOXNAVIGATIONCORE_SWIFT_H
#define MAPBOXNAVIGATIONCORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MapboxNavigationCore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class CLLocation;
@interface NavigationLocationManager (SWIFT_EXTENSION(MapboxNavigationCore)) <CLLocationManagerDelegate>
...
SWIFT_CLASS("_TtC20MapboxNavigationCore17NavigationMapView")
@interface NavigationMapView : UIView
...
@property (nonatomic, strong) UIColor * _Nonnull routeAnnotationSelectedCaptionTextColor;
...
@property (nonatomic, strong) UIColor * _Nonnull routeAnnotationCaptionTextColor;
/// Configures the text color of the route annotation for alternative routes when relative duration is greater then
/// the main route.
@property (nonatomic, strong) UIColor * _Nonnull routeAnnotationMoreTimeTextColor SWIFT_DEPRECATED_MSG("Has no effect in current design. Use `routeAnnotationTextColor` and `routeAnnotationCaptionTextColor` instead.");
@property (nonatomic, strong) UIColor * _Nonnull deprecatedRouteAnnotationMoreTimeTextColor;
/// Configures the text color of the route annotation for alternative routes when relative duration is lesser then
/// the main route.
@property (nonatomic, strong) UIColor * _Nonnull routeAnnotationLessTimeTextColor SWIFT_DEPRECATED_MSG("Has no effect in current design. Use `routeAnnotationTextColor` and `routeAnnotationCaptionTextColor` instead.");
@property (nonatomic, strong) UIColor * _Nonnull deprecatedRouteAnnotationLessTimeTextColor;
...
@property (nonatomic, strong) UIFont * _Nonnull routeAnnotationCaptionTextFont;
/// Configures the waypoint color.
@property (nonatomic, strong) UIColor * _Nonnull waypointColor;
/// Configures the waypoint stroke color.
@property (nonatomic, strong) UIColor * _Nonnull waypointStrokeColor;
@end

@class UIGestureRecognizer;
@interface NavigationMapView (SWIFT_EXTENSION(MapboxNavigationCore)) <UIGestureRecognizerDelegate>
...
SWIFT_CLASS("_TtC20MapboxNavigationCore23SystemSpeechSynthesizer")
...
@interface SystemSpeechSynthesizer (SWIFT_EXTENSION(MapboxNavigationCore)) <AVSpeechSynthesizerDelegate>
