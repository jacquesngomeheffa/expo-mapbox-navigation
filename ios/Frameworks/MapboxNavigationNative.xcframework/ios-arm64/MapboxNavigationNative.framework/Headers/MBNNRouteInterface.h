...
/**
 * This is a directions route response for current route with additional context from full directions route response.
 * See more: directions-route/flatbuffers/directions_route_context.fbs
 */
- (nonnull MBXDataRef *)getDirectionsRouteContextRef;
