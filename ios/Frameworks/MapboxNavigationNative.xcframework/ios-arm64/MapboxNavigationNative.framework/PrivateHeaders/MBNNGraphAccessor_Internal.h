 ...
 */
- (nonnull instancetype)initWithCache:(nonnull MBNNCacheHandle *)cache __attribute__((deprecated));

- (nonnull instancetype)initWithTilesManager:(nonnull MBNNTilesManagerHandle *)tilesManager;
/**
 * WARNING: This API is not intended for public usage. It can be deleted or changed without any notice.
