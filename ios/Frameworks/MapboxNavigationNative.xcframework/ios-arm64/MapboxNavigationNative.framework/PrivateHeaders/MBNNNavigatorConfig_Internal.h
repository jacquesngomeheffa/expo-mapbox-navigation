...
@class MBNNRoadObjectsMatcherOptions;
...
- (nonnull instancetype)initWithVoiceInstructionThreshold:(nullable NSNumber *)voiceInstructionThreshold
                             ...
                             rerouteStrategyForMatchRoute:(MBNNRerouteStrategyForMatchRoute)rerouteStrategyForMatchRoute
                                roadObjectsMatcherOptions:(nullable MBNNRoadObjectsMatcherOptions *)roadObjectsMatcherOptions;
...
/**
 * WARNING: This API is not intended for public usage. It can be deleted or changed without any notice.
 * Set behavior of going off-route from the current route built with map-matched api.
 */
@property (nonatomic, readwrite) MBNNRerouteStrategyForMatchRoute rerouteStrategyForMatchRoute;

/**
 * WARNING: This API is not intended for public usage. It can be deleted or changed without any notice.
 * Road objects matcher configuration
 */
@property (nonatomic, readwrite, nullable) MBNNRoadObjectsMatcherOptions *roadObjectsMatcherOptions;
