...
NS_SWIFT_NAME(RoadObjectsMatcherOptions)
__attribute__((visibility ("default")))
@interface MBNNRoadObjectsMatcherOptions : NSObject
...
- (nonnull instancetype)initWithOpenlrMaxDistanceToNode:(nullable NSNumber *)openlrMaxDistanceToNode
                                      matchingGraphType:(MBXTileDataDomain)matchingGraphType;
...
/** Determine if `RoadObjectsMatcher` should match road objects to SD or HD graph. */
@property (nonatomic, readonly) MBXTileDataDomain matchingGraphType;
